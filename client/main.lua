...
RegisterNetEvent('strez:client:SendMailTsunamiAuto5', function(text)
    ...
    TriggerServerEvent('roadphone:receiveMail', {
        sender = 'District of Los Santos',
        subject = "Emergency Broadcast",
        message = 'The National Weather Service has issued a TSUNAMI WARNING for Los Santos, In 5 minutes! Please start heading home or somewhere local for SAFETY!',
        image = '/public/html/static/img/icons/app/mail.png'
     })
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto1', function(text)
    ...
    TriggerServerEvent('roadphone:receiveMail', {
        sender = 'District of Los Santos',
        subject = "Emergency Broadcast",
        message = 'The National Weather Service has issued a TSUNAMI WARNING for Los Santos, In 1 minute! Please start heading home or somewhere local for SAFETY!',
        image = '/public/html/static/img/icons/app/mail.png'
     })
    Wait(math.random(13000, 23000))
    TsunamiEffect()
